...
export type ConnectionMode = SessionMode;

export const BLUETOOTH_ROOM_MIN = 100;
export const BLUETOOTH_ROOM_MAX = 399;
export const NEARBY_ROOM_MIN = 400;
...
export function connectionModeForRoomCode(roomCode: number): ConnectionMode | null {
  ...
  if (roomCode >= BLUETOOTH_ROOM_MIN && roomCode <= BLUETOOTH_ROOM_MAX) return 'bluetooth';
