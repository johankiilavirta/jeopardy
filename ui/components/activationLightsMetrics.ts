...
/** Fully-lit pause after the instant buzzer activation frame and before the
 *  outside-in drain begins. Reduced 75% from the original 1320ms cadence. */
export const FLASH_MS = 330;
