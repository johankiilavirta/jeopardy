...
export function PlayerHeader({ players, currentTurnPlayerId, localPlayerId, disconnectedPlayerId, judgingPlayerId, animationsEnabled = true, hideScores = false }: PlayerHeaderProps) {
